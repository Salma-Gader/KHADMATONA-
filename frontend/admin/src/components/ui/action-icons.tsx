...
export function PencilIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth={1.8}>
      ...
      <path d="M13.5 7 17 10.5" strokeLinecap="round" />
    </svg>
  );
}
...
export function TrashIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth={1.8}>
      ...
      <path d="M9 7V4.5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1V7M6 7l1 12.5a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1L18 7" strokeLinecap="round" strokeLinejoin="round" />
...
export function CopyIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth={1.8}>
      ...
      <path d="M15.5 8.5V6a2 2 0 0 0-2-2H5.5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h2.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
